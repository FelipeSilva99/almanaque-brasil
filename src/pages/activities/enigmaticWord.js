...
function EnigmaticWord({ activitie, handlerNextActivitie, registerAction, isLastActivity }) {
  ...
  return (
    isLoading ? <SplashScreen activitieLogo={logo} /> : (
      <Container>
        ...
        {modalCorrectAnswer && <CorrectAnswer answer={activitie.answer} toScore amountTrial={amountTrial}/>}
        {showAnswer && <CorrectAnswer answer={activitie.answer} amountTrial={amountTrial}/>}
      </Container>
    )
  )
}
